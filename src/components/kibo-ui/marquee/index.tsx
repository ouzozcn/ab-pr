...
interface FastMarqueeExport {
	default?: ComponentType<FastMarqueeProps>;
}

const FastMarquee =
	(FastMarqueeModule as FastMarqueeExport).default ??
	(FastMarqueeModule as ComponentType<FastMarqueeProps>);
